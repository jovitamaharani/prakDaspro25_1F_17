...
public class indeksprestasi17 {
    public static void main(String[] args) {
        ...
        if (pancasila17 > 80 && pancasila17 <= 100) {
            ...
            setarapancasila17 = 0;
            hurufPancasila17 = "E";
        } else if (pancasila17 < 0 || pancasila17 > 100) {
        ...
        if (daspro17 > 80 && daspro17 <= 100) {
            ...
            setaradaspro17 = 0;
            hurufDaspro17 = "E";
        } else if (daspro17 < 0 || daspro17 > 100) {
            System.out.println("Nilai tidak valid harus (0-100)!!");
        } else {
            System.out.println("Nilai tidak valid harus (0-100)!!");
        }
        ...
        System.out.println("------------------------------------------------");
        System.out.println("Pancasila \t " + skspancasila17 + " \t " + pancasila17 + " \t " + hurufPancasila17 + "\t"
                + setarapancasila17);
        System.out.println(
